const wrapper = document.querySelector(".scroll-slide");
const slides = document.querySelector(".slides");
const firstSlideWidth = slides.querySelector(".slide").offsetWidth;
const arrowBtns = document.querySelectorAll(".scroll-slide .icon");
const slideChildrens = [...slides.children];
...
slideChildrens.slice(-slidePerView).reverse().forEach(slide => {
...
slideChildrens.slice(0, slidePerView).forEach(slide => {
